			...
			<div class="row">
				<div class="col-xs-12">
					...
					<div class="table-header">
						<a href="<?php echo base_url().'pengurus/inptsimipananpokok'; ?>" class="btn btn-success">Tambah Data</i></a>
					</div>
								...
								$no=0;
									foreach ($data as $key) {
										...
										echo "<tr>";
											...
											echo '<td><a href="#my-modal" onclick="edit(this)" data-toggle="modal" data-id="'.$key->id_spokok.'">Edit</a></td>';
										echo "</tr>";
									}
								 ?>
							</tbody>
		...
		<div class="modal-dialog">
			<div class="modal-content">
				...
				<div class="modal-body">
					<form class="form-horizontal" role="form" action="<?php echo base_url().'pengurus/upda_simpokok'; ?>" method="post" enctype="multipart/form-data">
...
<script>
	function edit(row){var form_data = new FormData();
		...
		$.ajax({
			url:'<?php echo base_url() ?>pengurus/showdataeditsimpokok',
			dataType:'text',
			cache:false,
			contentType:false,
			processData:false,
