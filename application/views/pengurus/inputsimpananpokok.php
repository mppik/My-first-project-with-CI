	...
	<div class="main-content-inner">
			<div class="breadcrumbs ace-save-state" id="breadcrumbs">
				<ul class="breadcrumb">
					...
					<li class="active"><a href="<?php echo base_url('pengurus/formsimpananpokok'); ?>">Form Simpanan Pokok</a></li>
					<li>Tambah data</li>
				</ul>
			</div>
		<div class="page-content">
			<div class="row">
				<div class="col-xs-12">
					<!-- PAGE CONTENT BEGINS -->
					<form class="form-horizontal" role="form" action="<?php echo base_url().'pengurus/simpan_simpokok'; ?>" method="post" enctype="multipart/form-data">
